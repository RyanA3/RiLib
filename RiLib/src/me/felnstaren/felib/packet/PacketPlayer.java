...
import me.felnstaren.felib.ui.progress.BossBar;
...
public class PacketPlayer {
	...
	public PacketPlayer(Player player) {
		try {
			...
			e.printStackTrace();
			FeLib.LOGGER.log(Level.WARNING, "ERROR - GET PLAYER CONNECTION - " + player.getName());
		}
	}
	...
	public void send(Object packet) {
		try {
			...
			e.printStackTrace();
			FeLib.LOGGER.log(Level.WARNING, "ERROR - SEND PACKET TO PLAYER");
		}
	}
	...
	public void sendBossBar(BossBar bar) {
