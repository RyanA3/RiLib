...
public class PacketParticle {
	...
	public void send(Player player, double offx, double offy, double offz) {
		try {
			Object packet = Reflector.CONSTRUCTOR_CACHE.get(Reflector.getNMSClass("PacketPlayOutWorldParticles")).newInstance(getParticleParam(), true, offx, offy, offz, vx, vy, vz, speed, count);
